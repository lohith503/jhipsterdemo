(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jhipsterDemoApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jhipsterDemoApp-error');
                var entityKey = httpResponse.headers('X-jhipsterDemoApp-params');
                if (errorHeader) {
